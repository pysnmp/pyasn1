...
# built documents.
#
# Read from the installed package metadata so the docs cannot drift from the
# version semantic-release writes into pyproject.toml.
try:
    release = _version("pysnmp-pyasn1")
...
html_theme_options = {
    "light_logo": "logo.svg",
    "dark_logo": "logo.svg",
    "source_repository": "https://github.com/pysnmp/pyasn1/",
    "source_branch": "main",
